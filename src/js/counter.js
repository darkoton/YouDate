                  ...
                  (u.timer = Ue(
                    function () {
                      ...
                      if (
                        ...
                        return l === cn && (l = null), (u.value = new Array(o.format.length).fill(0)), u.nextScheduledDate && (u.previouslyScheduledDate = O(u.nextScheduledDate)), (u.nextScheduledDate = null === s ? null : O(s)), void u.onwait(u.previouslyScheduledDate ? O(u.previouslyScheduledDate) : null);
